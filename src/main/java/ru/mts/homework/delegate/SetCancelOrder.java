...
@Log4j
@Component
public class SetCancelOrder implements JavaDelegate {

    @Autowired
    private KafkaTemplate<String, Order> orderKafkaTemplate;

    private static final Logger LOG = LogManager.getLogger(SetCancelOrder.class.getName());
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        LOG.debug("name: " + order.getName() + " CANCELLED");
    }
}
