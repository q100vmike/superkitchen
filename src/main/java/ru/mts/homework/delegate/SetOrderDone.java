...
@Log4j
@Component
public class SetOrderDone implements JavaDelegate {

    @Autowired
    private KafkaTemplate<String, Order> orderKafkaTemplate;

    private static final Logger LOG = LogManager.getLogger(SetOrderDone.class.getName());
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        LOG.debug("name: " + order.getName() + " DONE");
    }
}
